...
import edu.scripps.yates.pcomplex.db.QuickGODB;

public class QuickGOTest {
		...
		try {
			...
			for (int i = 0; i < taxIDs.length; i++) {
				...
				final File intActFile = new File(
						"C:\\Users\\salvador\\Dropbox (Scripps Research)\\beta_cells_PCP\\databases\\QuickGO\\quickGO_"
								+ species + ".tsv");
				final QuickGODB dbHuman = new QuickGODB(intActFile, taxID,
